...
const heroBackground = "/images/harmony-woods-video.mp4";

const propertyDetails = {
  title: "JB's Harmony Woods",
  location: "Srisilam Highway near Thummaloor, Future City",
...
const features = [
  { icon: FaCertificate, title: "Premium Development", description: "Well-planned residential development ensuring quality and legal compliance" },
  ...
  { icon: FaMapMarkerAlt, title: "Strategic Location", description: "Prime location on Srisilam Highway with excellent connectivity and growth potential" },
];
...
const images = [
  "/images/harmony-woods-1.jpeg",
  "/images/harmony-woods-2.jpeg",
];

const videos = [
  "/images/harmony-woods-video.mp4",
];

const PropertyHarmonyWoods = () => {
  useInViewAnimation();
  ...
  return (
    <div className="min-h-screen bg-white text-brand">
      <SEO
        ...
        description="JB's Harmony Woods - Premium residential development on Srisilam Highway near Thummaloor in Future City. Strategically located with modern amenities and excellent growth potential."
        keywords={[
          "JB's Harmony Woods",
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-brand pt-20 text-white md:min-h-[60vh] md:pt-24">
        <video
          ...
          onError={(e) => {
            ...
            e.target.parentElement.style.backgroundImage = 'url(/images/construction3.webp)';
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-brand/70 md:text-base lg:text-lg">
              {propertyDetails.description} Located strategically on Srisilam Highway near Thummaloor, this premium residential development offers an exceptional living experience with modern amenities and excellent connectivity to major business districts.
            </p>
            <div className="grid grid-cols-2 gap-4 rounded-2xl bg-brand/5 p-6 md:rounded-3xl md:p-8">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brand/60 md:text-sm">Location</p>
                <p className="mt-1 text-lg font-semibold text-brand md:text-xl">Future City</p>
              </div>
              <div>
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-brand/5">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/images/construction3.webp";
                }}
              />
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Location"
                title="Prime Location on Srisilam Highway"
              ...
              <ul className="space-y-3 text-sm text-brand/70 md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>Located on Srisilam Highway near Thummaloor in Future City</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                  <span>Excellent connectivity to major business districts</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                ...
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                  <span>High growth potential in the Future City region</span>
                </li>
              </ul>
            </div>
            <div className="overflow-hidden rounded-3xl shadow-[0_30px_70px_rgba(15,23,42,0.15)]">
...
export default PropertyHarmonyWoods;

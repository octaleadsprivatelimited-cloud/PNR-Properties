...
const heroBackground = "/images/nature-valley-video.mp4";

const propertyDetails = {
  title: "JB's Nature Valley",
  location: "NH-65 HYD-VIJAYAWADA Highway near Gundrampally, Choutuppal",
  approval: "DTCP & RERA Approved",
  area: "700 Acres",
  type: "Integrated Satellite Township",
  description: "Premium integrated satellite township on NH-65 Highway with world-class amenities, free clubhouse membership, and exceptional living experience.",
};

const features = [
  { icon: FaCertificate, title: "DTCP & RERA Approved", description: "Fully approved layout ensuring legal compliance and buyer protection" },
  ...
  { icon: FaHome, title: "Residential Plots", description: "Premium residential plots in a well-planned satellite township" },
  { icon: FaSwimmingPool, title: "Clubhouse Facilities", description: "Free clubhouse membership with world-class amenities and recreational facilities" },
  ...
  { icon: FaMapMarkerAlt, title: "Strategic Location", description: "Prime location on NH-65 Highway with excellent connectivity" },
];
...
const images = [
  "/images/nature-valley-1.jpeg",
  "/images/nature-valley-2.jpeg",
];

const videos = [
  "/images/nature-valley-video.mp4",
];

const PropertyNatureValley = () => {
  useInViewAnimation();
  ...
  return (
    <div className="min-h-screen bg-white text-brand">
      <SEO
        title="JB's Nature Valley - NH-65 Highway, Choutuppal"
        description="JB's Nature Valley - DTCP & RERA Approved 700 Acres Integrated Satellite Township on NH-65 HYD-VIJAYAWADA Highway near Gundrampally, Choutuppal. Free clubhouse membership with world-class amenities."
        keywords={[
          "JB's Nature Valley",
          "Choutuppal properties",
          "NH-65 Highway",
          "DTCP approved",
          "RERA approved",
          "700 acres township",
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-brand pt-20 text-white md:min-h-[60vh] md:pt-24">
        <video
          ...
          onError={(e) => {
            ...
            e.target.parentElement.style.backgroundImage = 'url(/images/construction-premium.avif)';
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center md:px-6 md:py-24 lg:px-8">
          ...
          <p className="mt-4 text-sm text-white/90 md:mt-6 md:text-base lg:text-lg">
            DTCP & RERA Approved 700 Acres Integrated Satellite Township with World-Class Amenities
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-brand/70 md:text-base lg:text-lg">
              {propertyDetails.description} Located strategically on NH-65 Highway connecting Hyderabad and Vijayawada, this premium integrated satellite township offers an exceptional living experience with modern amenities and excellent connectivity.
            </p>
      ...
      <section className="fade-up mx-auto mt-12 w-full max-w-6xl px-4 py-8 md:px-6 md:py-12 lg:px-10">
        <SectionHeading
          ...
          description="Explore the premium integrated satellite township through our gallery"
          align="center"
          tone="light"
        />
        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Location"
                title="Prime Location on NH-65 Highway"
              ...
              <ul className="space-y-3 text-sm text-brand/70 md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>Located on NH-65 Highway connecting Hyderabad and Vijayawada</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                  <span>Near Gundrampally, Choutuppal - Emerging residential hub</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                  <span>Excellent connectivity to major cities and business districts</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-12 md:px-6 md:py-16 lg:px-10">
          <div className="text-center text-white">
            <h2 className="text-2xl font-semibold md:text-3xl lg:text-4xl">
              Interested in JB's Nature Valley?
            </h2>
            <p className="mt-4 text-sm text-white/90 md:text-base lg:text-lg">
              Contact us today to schedule a site visit and learn more about this premium integrated satellite township
            </p>
...
export default PropertyNatureValley;

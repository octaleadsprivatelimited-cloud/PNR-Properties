...
const heroBackground = "/images/pride-video.mp4";

const propertyDetails = {
  title: "JB's Pride",
  location: "Shankarpally Highway near Mominpet",
...
const features = [
  ...
  { icon: FaSwimmingPool, title: "World-Class Amenities", description: "Modern amenities and recreational facilities for residents" },
  ...
  { icon: FaMapMarkerAlt, title: "Strategic Location", description: "Prime location on Shankarpally Highway with excellent connectivity" },
];
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-brand pt-20 text-white md:min-h-[60vh] md:pt-24">
        <video
          ...
          onError={(e) => {
            ...
            e.target.parentElement.style.backgroundImage = 'url(/images/construction1.webp)';
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-brand/70 md:text-base lg:text-lg">
              {propertyDetails.description} This premium residential development offers an exceptional living experience with modern amenities and excellent connectivity to major business districts.
            </p>
            <div className="grid grid-cols-2 gap-4 rounded-2xl bg-brand/5 p-6 md:rounded-3xl md:p-8">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold text-brand md:text-xl">DTCP & RERA</p>
              </div>
              <div>
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-brand/5">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/images/construction1.webp";
                }}
              />
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Location"
                title="Prime Location on Shankarpally Highway"
              ...
              <ul className="space-y-3 text-sm text-brand/70 md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>Located on Shankarpally Highway near Mominpet with excellent connectivity</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />

...
const heroBackground = "/images/serene-county1-video.mp4";

const propertyDetails = {
  title: "JB Serene County-1",
  location: "Near ORR Exit-13, Kongarakalan",
  approval: "HMDA & TS-RERA Approved",
  area: "Premium Residential Layout",
  type: "Residential Development",
  description: "Premium HMDA & TS-RERA Approved residential development near ORR Exit-13, Kongarakalan. Strategically located with excellent connectivity and premium residential facilities.",
};

const features = [
  { icon: FaCertificate, title: "HMDA & TS-RERA Approved", description: "Fully approved layout ensuring legal compliance and buyer protection" },
  ...
  { icon: FaMapMarkerAlt, title: "Strategic Location", description: "Prime location near ORR Exit-13 with excellent connectivity" },
];
...
const images = [
  "/images/serene-county1-1.jpeg",
  "/images/serene-county1-2.jpeg",
];

const videos = [
  "/images/serene-county1-video.mp4",
];

const PropertySereneCounty1 = () => {
  useInViewAnimation();
  ...
  return (
    <div className="min-h-screen bg-white text-brand">
      <SEO
        title="JB Serene County-1 - ORR Exit-13, Kongarakalan"
        description="JB Serene County-1 - HMDA & TS-RERA Approved premium residential development near ORR Exit-13, Kongarakalan. Strategically located with excellent connectivity and premium facilities."
        keywords={[
          "JB Serene County-1",
          "Kongarakalan properties",
          "ORR Exit-13",
          "HMDA approved",
          "TS-RERA approved",
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-brand pt-20 text-white md:min-h-[60vh] md:pt-24">
        <video
          ...
          onError={(e) => {
            ...
            e.target.parentElement.style.backgroundImage = 'url(/images/construction-site-3.avif)';
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center md:px-6 md:py-24 lg:px-8">
          ...
          <p className="mt-4 text-sm text-white/90 md:mt-6 md:text-base lg:text-lg">
            HMDA & TS-RERA Approved Premium Residential Development with Excellent Connectivity
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-brand/70 md:text-base lg:text-lg">
              {propertyDetails.description} Located strategically near ORR Exit-13, Kongarakalan, this premium residential development offers an exceptional living experience with modern amenities and excellent connectivity to major business districts.
            </p>
            <div className="grid grid-cols-2 gap-4 rounded-2xl bg-brand/5 p-6 md:rounded-3xl md:p-8">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold text-brand md:text-xl">HMDA & TS-RERA</p>
              </div>
              <div>
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-brand/5">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/images/construction-site-3.avif";
                }}
              />
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Location"
                title="Prime Location near ORR Exit-13"
              ...
              <ul className="space-y-3 text-sm text-brand/70 md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>Located near ORR Exit-13, Kongarakalan with excellent connectivity</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-12 md:px-6 md:py-16 lg:px-10">
          <div className="text-center text-white">
            <h2 className="text-2xl font-semibold md:text-3xl lg:text-4xl">
              Interested in JB Serene County-1?
            </h2>
...
export default PropertySereneCounty1;

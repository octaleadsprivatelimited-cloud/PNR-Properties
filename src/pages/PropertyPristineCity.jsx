...
const heroBackground = "/images/pristine-city-video.mp4";

const propertyDetails = {
  title: "JB's Pristine City",
  location: "Vikarabad Town",
  approval: "DTCP & TG-RERA Approved",
  area: "Premium Residential Layout",
  type: "Residential Development",
  description: "DTCP & TG-RERA Approved premium residential development in Vikarabad Town. Features modern amenities and free Clubhouse membership included.",
};

const features = [
  { icon: FaCertificate, title: "DTCP & TG-RERA Approved", description: "Fully approved layout ensuring legal compliance and buyer protection" },
  ...
  { icon: FaMapMarkerAlt, title: "Strategic Location", description: "Prime location in Vikarabad Town with excellent connectivity" },
];
...
const images = [
  "/images/pristine-city-1.jpeg",
  "/images/pristine-city-2.jpeg",
];

const videos = [
  "/images/pristine-city-video.mp4",
];

const PropertyPristineCity = () => {
  useInViewAnimation();
  ...
  return (
    <div className="min-h-screen bg-white text-brand">
      <SEO
        title="JB's Pristine City - Vikarabad Town"
        description="JB's Pristine City - DTCP & TG-RERA Approved premium residential development in Vikarabad Town. Features modern amenities and free Clubhouse membership."
        keywords={[
          "JB's Pristine City",
          "Vikarabad properties",
          "DTCP approved",
          "TG-RERA approved",
      ...
      <section className="relative flex min-h-[50vh] items-center justify-center overflow-hidden bg-brand pt-20 text-white md:min-h-[60vh] md:pt-24">
        <video
          ...
          onError={(e) => {
            ...
            e.target.parentElement.style.backgroundImage = 'url(/images/construction-site-2.avif)';
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center md:px-6 md:py-24 lg:px-8">
          ...
          <p className="mt-4 text-sm text-white/90 md:mt-6 md:text-base lg:text-lg">
            DTCP & TG-RERA Approved Premium Residential Development with Free Clubhouse Membership
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-brand/70 md:text-base lg:text-lg">
              {propertyDetails.description} Located strategically in Vikarabad Town, this premium residential development offers an exceptional living experience with modern amenities and excellent connectivity to major business districts.
            </p>
            <div className="grid grid-cols-2 gap-4 rounded-2xl bg-brand/5 p-6 md:rounded-3xl md:p-8">
              <div>
                ...
                <p className="mt-1 text-lg font-semibold text-brand md:text-xl">DTCP & TG-RERA</p>
              </div>
              <div>
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-brand/5">
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "/images/construction-site-2.avif";
                }}
              />
            </div>
          </div>
        ...
        <div className="mx-auto w-full max-w-6xl px-4 md:px-6 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
            <div className="space-y-6">
              <SectionHeading
                eyebrow="Location"
                title="Prime Location in Vikarabad Town"
              ...
              <ul className="space-y-3 text-sm text-brand/70 md:text-base">
                <li className="flex items-start gap-3">
                  ...
                  <span>Located in Vikarabad Town with excellent connectivity</span>
                </li>
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                ...
                <li className="flex items-start gap-3">
                  <FaCheckCircle className="mt-1 h-5 w-5 shrink-0 text-brand-accent" />
                  <span>Growing infrastructure and development in Vikarabad region</span>
                </li>
              </ul>
            </div>
            <div className="overflow-hidden rounded-3xl shadow-[0_30px_70px_rgba(15,23,42,0.15)]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-4 py-12 md:px-6 md:py-16 lg:px-10">
          <div className="text-center text-white">
            <h2 className="text-2xl font-semibold md:text-3xl lg:text-4xl">
              Interested in JB's Pristine City?
            </h2>
...
export default PropertyPristineCity;
